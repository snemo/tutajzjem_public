...
<div class="panel panel-default">
	<div class="panel-heading">Karta menu</div>
	<div class="panel-body">
		...
		<div class="permanentmenu-groups" counter="1">
			<div id="group-0" class="permanentmenu-group" position="0">
					<div class="input-group permanentmenu-category">
						...
						<span class="btn btn-danger input-group-addon permanentmenu-group-remove">
				...
				<div class="permanentmenu-items" counter="1">
					<div id="item-0" class="permanentmenu-item" position="0">
						<div class="row">
							...
							<div class="permanentmenu-item-price">
								<div class="input-group permanentmenu-item-price-input">
									<span class="input-group-addon">Cena:</span>
									<input type="text" class="form-control itemprice" placeholder="Brak">
									<span class="input-group-addon">zł</span>
									<span class="btn btn-danger input-group-addon permanentmenu-item-remove">
								        <i class="glyphicon glyphicon-remove"></i>
								    </span>
								</div>
							</div>
		...
		<hr>
		<form id="menu-form" role="form" method="post" action="<g:createLink controller="permanentmenu" action="save" />">
			<input id="data" type="hidden" name="data" value="">
			<input id="id" type="hidden" name="id" value="${restaurant?.identifier}">
			
			<span id="save-btn" class="btn btn-lg btn-primary next-btn permanentmenu-savebtn">
...
<script id="init-data" type="application/json">${restaurant?.permanentMenu?.menu}</script>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$(".permanentmenu-group-remove").live("click", function() {
			$(this).parent().parent().remove();
		});

		$(".permanentmenu-item-remove").live("click", function() {
