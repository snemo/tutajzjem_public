...
<head>
	...
	<g:javascript src='handlebars-utils.js' />
...
<body>
	<div class="top-header">
		<div class="menu-container">
			<div class="centered">
				<a class="menu-logo" href="<g:createLink controller="manager" action="index"/>"></a>
				<div class="navbar-right manager-logout">
					<a class="navbar-brand orange-link" href="<g:createLink controller="logout" action="index"/>">
