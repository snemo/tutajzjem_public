...
<html>
	<head>
		...
		<title>Utwórz nową restaurajce</title>
	</head>
	<body>
		...
		<div id="create-restaurant" class="content scaffold-create" role="main">
			...
			<div class="panel panel-default">
				<div class="panel-heading"><h4>Utwórz nowy lokal gastronomiczny</h4></div>
				<div class="panel-body">
					<g:form url="[resource:restaurantInstance, action:'save']" class="form-horizontal new-restaurant">
